        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="index.php?route=delivery" class="btn btn-primary w-100 mt-3">Checkout</a>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $('.remove-btn').off('click').on('click', function() {
        ...
        if (confirm('Remove this item from cart?')) {
            $.post('index.php?route=cart_remove', { item_id: itemId }, function(response) {
    ...
    function updateCart(itemId, quantity, $span) {
        $.post('index.php?route=cart_update', { 
            item_id: itemId, 
            quantity: quantity 
        }, function(response) {
            let result = JSON.parse(response);
