...
$tables = [
    ...
    'Reviews' => ['User_Id', 'Order_Id', 'Item_Id', 'Rating', 'Review_Text']   
];

// Display message from AdminController
$message = '';
...
<div class="container">
    ...
    <form action="index.php?route=admin_insert" method="POST">
        <div class="row g-3">
            <div class="col-md-3">
...
document.getElementById('tableSelect').addEventListener('change', function() {
    const fields = {
        ...
        'Reviews': [
            ...
            {name: 'Rating', type: 'number', step: '1', required: true},
